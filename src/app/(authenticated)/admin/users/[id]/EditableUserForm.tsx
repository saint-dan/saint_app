...
export default function EditableUserForm({ userDetails, locations }: { userDetails: any, locations: any[] }) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 sm:p-12 relative">
      ...
      {/* Edit Toggle Buttons */}
      <div className="absolute top-6 right-8 sm:top-10 sm:right-12 z-10">
        {!isEditing ? (
          <button 
      ...
      <div className="space-y-10 mt-6 sm:mt-0">
        ...
        {/* Overview Header */}
        <div className="flex items-center gap-5 pb-8 border-b border-slate-100 pr-0 sm:pr-48">
